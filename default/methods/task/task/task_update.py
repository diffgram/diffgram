...
class Task_Update():
	...
	def defer(self):
		...
		# I think it's reasonable to track that something
		# was done, and the 'task' in a sense is complete
		# create_review_sub_task makes it's own...
		self.task.job.stat_count_complete += 1
