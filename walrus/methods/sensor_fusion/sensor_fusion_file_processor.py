...
class SensorFusionFileProcessor:
    ...
    def __load_sensor_fusion_json(self) -> dict:
        ...
        with open(self.input.temp_dir_path_and_filename, 'rb', encoding = 'utf-8', errors = 'ignore') as json_data:
            str_data = json_data.read()
            sensor_fusion_spec = json.loads(str_data)
