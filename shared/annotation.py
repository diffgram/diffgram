...
class Annotation_Update():
	...
	def update_instance_list(self,
		...
		try:
			...
			communicate_via_email.send(settings.DEFAULT_ENGINEERING_EMAIL, '[Exception] Duplicate ID On Annotation_Update', str(self.log))
	...
	def update_instance(self,
		...
		try:	 # wrap new concept in try block just in case
			...
			communicate_via_email.send(settings.DEFAULT_ENGINEERING_EMAIL, '[Exception] __validate_user_deletion', str(self.log))
