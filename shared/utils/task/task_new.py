# OPENCORE - ADD
try: 	from methods.regular.regular_api import *
except: from default.methods.regular.regular_api import *

from shared.database.user import UserbaseProject


def provision_root_tasks_api(job_id):
	...
	with sessionMaker.session_scope() as session:
		...
		result = provision_root_tasks(session = session,
									  job = job)
