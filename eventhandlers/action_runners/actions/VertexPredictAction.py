...
class VertexPredictAction(ActionRunner):
    public_name = 'Vertex AI Object Detection'
    description = 'Prelabel images with Vertex AI'
    icon = 'https://www.svgrepo.com/show/375510/vertexai.svg'
    precondition = ActionCondition(default_event = None, event_list = [])
    kind = 'VertexPredictAction'  # The kind has to be unique to all actions
    category = 'Object detection'  # Optional
