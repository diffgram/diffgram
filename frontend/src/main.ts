...
import thumbnail from './components/annotation/image_annotation/thumbnail'
...
import is_complete from './components/annotation/image_annotation/actions/is_complete'
...
import labels_new from './components/annotation/image_annotation/labels_new'
import labels_edit from './components/annotation/image_annotation/labels_edit'

import { Chrome } from 'vue-color'

import job_cancel from './components/task/job/job_cancel'

import annotation_trainer_menu from './components/annotation/image_annotation/trainer/trainer_menu'
import annotation_trainer_job_info from './components/annotation/image_annotation/trainer/trainer_job_info'

import annotation_core from './components/annotation/image_annotation/annotation_core'

import vue_scroll_to from 'vue-scrollto'
import media_core from './components/annotation/image_annotation/media_core'
