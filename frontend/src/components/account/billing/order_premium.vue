            ...
            <v-card elevation=0>
              ...
              <ol>
                <li>
                  ...
                  Teams start working instantly instead of waiting for each dataset to be ready. This directly saves days off the monthly schedule.
                </li>

                <li>
                  <b> Keep working longer. </b>
                  The event driven system means once a pipeline is set up new fresh data is instantly available to annotators. This evens out supervision cycles, making for more even monthly work distribution, reducing daily bottlenecks by up to 40%.
                  <li>

                  <b> Work on the right thing. </b>
 By focusing on improving existing models, adding new cases, and improving coverage of scenarios. This makes the team more productive in the global sense of the word. Avoid weeks of mistaken, or low value, supervision work!
                  </li>
                ...
                Diffgram has an array of features that help make your team more productive, from advanced annotation UIs, to integrated communication on issues, to timely notifications and more.
...
Using integrations, pre-processing, and the SDK, there is less data engineering work when using Diffgram. This affects both upfront setup costs, and especially ongoing costs for new data. Save 10s of people hours of work every month.

                <li>
                  <b> Bells and Whistles Included. </b>
The brunt of software work is maintenance. Instead of having engineering reinvent the wheel (and the spoke), shift the burden to Diffgram. This helps save engineering focus and the engineering roadmap.

                <li>

                  <b> Less Engineering Risk. </b>
By having one central schema definition for resource definitions engineering reduces errors and better tracks changes. This reduces the potential for major blunders, especially for growing teams.
                  </li>
...
Diffgram helps coordinate areas of responsibility for different team members. This reduces costs of ad hoc engineering callouts and expensive cross-functional epics. Shift the engineering conversation to how to get the most value out of the data, instead of the plumbing.
...
The combination of productivity and engineering benefits, plus tools like reporting and discussions, help you ship the best overall AI product. Collectively, this does more then reduce costs - it results in a better overall sales and revenue.

                <li>
                  <b> Less Management Costs.</b>
 The bigger the projects, the more the people and process challenges. Diffgram provides the blueprints to help organize the work - deeply integrated into every aspect of Diffgram. This lowers leadership and planning costs.

                  </li>
                <li>

                  <b> An Insurance Policy. </b>
                  Avoid data loss. It’s surprisingly common for data to be worked on, only to realize the wrong labels (or assumptions) were used. People forget what sets contain what assumptions and more. Reduce the risk of an event jeopardizing the entire project.
...
AI projects are complex. With many moving parts, people, and data. Diffgram substantially improves the overall quality of the AI product, reduces the management costs, and provides a disaster insurance policy.
               </v-card-text>
            </v-card>
          </template>
...
export default Vue.extend( {
  ...
  computed: {
    ...
    monthly_or_annual() {
        if (this.annual_pricing) { return "Annually" }
        else { return "Monthly" }
    },
    ...
    productivity_benefit() {
        ...
        if (this. annual_pricing) { result = result * 12 }
        return result
    },
    engineering_benefit() {
