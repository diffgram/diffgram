    ...
    >
        ...
        -->
          ...
          >
            <ahref_seo_optimal :href="route_home">
              <v-toolbar-title
                data-cy="navbar-logo"
                class="ml-0 pt-2 pr-3 clickable"
      ...
      (new users have no mode enabled-->
            ...
            <div v-if="$store.state.builder_or_trainer.mode == 'trainer'">
              <h3 class="pr-3">
                <v-icon left color="primary">mdi-professional-hexagon</v-icon>
                Pro
              </h3>
            </div>
                ...
                >
                  <template v-slot:activator="{ on }">
                    <v-btn
                      ...
                      "
                      @click="
                        $store.commit('set_user_is_typing_or_menu_open', true)
                      "
                      text
                    >
                      Share
            ...
            >
              <template slot="content">
                <v-layout column>
                  ...
                  <v-btn @click="$router.push('/admin/')"> Projects </v-btn>
            ...
            <v_profile_in_menu class="hidden-xs-only"> </v_profile_in_menu>
          </v-toolbar>
        </v-layout>
