...
export default Vue.extend({
    ...
    mounted() {
      ...
      window.addEventListener('keydown', this.keyboard_down);

    },

    beforeDestroy() {
      window.removeEventListener('keyup', this.keyboard_events_window)
      window.removeEventListener('keydown', this.keyboard_down)
    },
