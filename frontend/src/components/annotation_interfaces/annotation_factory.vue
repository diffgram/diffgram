<template>
  <div>
    ...
    >
        ...
        <div 
            v-if="!annotation_interface && !initializing"
        >
        ...
        <div 
            v-else-if="!credentials_granted && !initializing"
        >
            <empty_file_editor_placeholder
        ...
        <div v-else-if="annotation_interface === 'geospatial'">
            <geo_annotation_core
                :file="current_file"
                :task="task"
                :job_id="job_id"
